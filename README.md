...
| Paid media | Google Ads transfer, Meta Ads API export, GA4 click/session/event data | `mart_performance_daily`, `mart_event_performance_daily`, keyword and attribution marts |
